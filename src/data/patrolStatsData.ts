...
export const patrolPersonnelStats = [
  { id: 'P001', name: '张明', distance: 156.8, patrolCount: 28, reportData: 45 },
  { id: 'P002', name: '李华', distance: 142.5, patrolCount: 25, reportData: 38 },
  { id: 'P003', name: '王强', distance: 138.2, patrolCount: 30, reportData: 52 },
  { id: 'P004', name: '刘伟', distance: 125.6, patrolCount: 22, reportData: 35 },
  { id: 'P005', name: '赵军', distance: 118.3, patrolCount: 24, reportData: 41 },
  { id: 'P006', name: '陈静', distance: 105.8, patrolCount: 20, reportData: 32 },
  { id: 'P007', name: '周伟', distance: 98.5, patrolCount: 18, reportData: 28 },
  { id: 'P008', name: '吴敏', distance: 92.1, patrolCount: 16, reportData: 25 },
  { id: 'P009', name: '孙磊', distance: 85.6, patrolCount: 15, reportData: 22 },
  { id: 'P010', name: '郑华', distance: 78.2, patrolCount: 14, reportData: 19 },
]
...
export function getPatrolDataByYearMonth(year: string, month: string | null) {
  ...
  const personnel = patrolPersonnelStats.map((p, idx) => ({
    ...
    reportData: Math.round(p.reportData * (1 + yearFactor * 0.08) * monthFactor + Math.random() * 8)
